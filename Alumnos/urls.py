...
from .views import AlumnosCreate, AlumnosList, AlumnosDetail, AlumnosUpdate, AlumnosDelete, AlumnosListView,MovAlumno, ReggisterApiView, LoginApiView, UserApiView, RefreshAPIView, LogoutApiView, CoordinatorAlumnosListView, verificar_authenticacion
...
urlpatterns = [
    ...
    path('verificar-autenticacion/', views.verificar_authenticacion, name='verificar-autenticacion'),
]
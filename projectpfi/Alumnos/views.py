...
def prueba(): 
    oalumno = Oalumno.objects.filter(cve_alumno = "1110499")
    print(oalumno)
    return JsonResponse(oalumno, safe=False)

def google_login(request):
    return OAuth2View.adapter_view(request, 'google')

def user_profiel(request):

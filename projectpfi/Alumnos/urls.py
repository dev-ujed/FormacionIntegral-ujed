...
from .views import AlumnosCreate, AlumnosList, AlumnosDetail, AlumnosUpdate, AlumnosDelete, AlumnosListView, prueba, MovAlumno, ReggisterApiView, LoginApiView, UserApiView, RefreshAPIView, LogoutApiView
...
urlpatterns = [
    ...
    path('prueba/', prueba, name='get_oalumnos'), 
